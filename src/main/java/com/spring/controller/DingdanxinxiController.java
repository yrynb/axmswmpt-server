...
public class DingdanxinxiController extends BaseController
{
    ...
    public String getWhere()
    {
        ...
        // 以下也是一样的操作，判断是否符合条件，符合则写入sql 语句
            ...
            where += " AND cuncanweizhi LIKE '%"+Request.get("cuncanweizhi")+"%' ";
                ...
                if(!Request.get("shifougeli").equals("")) {
            where += " AND shifougeli ='"+Request.get("shifougeli")+"' ";
        }
    ...
    public String insert()
    {
        ...
        post.setShifougeli(Request.get("shifougeli"));
        ...
        Query.execute("INSERT INTO dingdanxinxi_dingdanxinxi(dingdanxinxiid,shangpinxinxiid,shangpinbianhao,fenlei,shangpinmingcheng,tupian,jiage,goumaishuliang,xiaoji) SELECT '"+charuid+"',shangpinxinxiid,shangpinbianhao,fenlei,shangpinmingcheng,tupian,jiage,goumaishuliang,xiaoji FROM gouwuche WHERE goumairen='"+request.getSession().getAttribute("username")+"'");
