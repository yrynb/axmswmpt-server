...
public class UserController extends BaseController{
    ...
    protected String authLoginUser(boolean isAdmin,String username , String pwd,String cx)
    {
        ...
        if (cx.equals("配送员")) {
            Peisongyuan user = peisongyuanService.login(username , pwd);
            if(user == null){
                return showError("用户名或密码错误");
            }
                        session.setAttribute("id" , user.getId());
            ...
            session.setAttribute("login" , cx);
                        ...
                        session.setAttribute("peisongyuantiwen", user.getPeisongyuantiwen());
                        session.setAttribute("zhuangtai", user.getZhuangtai());
    ...
    public String tokenLogin()
    {
        ...
        if(cx.equals("配送员"))
        {
            user = peisongyuanService.find(tokenInfo.get("valueid"));
        }
        if(user == null){
    ...
    public String editPassword()
    {
        ...
        if (cx.equals("配送员")) {
            Peisongyuan user = peisongyuanService.login(username , oldPassword);
            if(user == null){
                return showError("原密码不正确");
            }
            peisongyuanService.updatePassword(user.getId() , newPwd);
        }
