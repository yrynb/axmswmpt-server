            ...
            <div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
                ...
                <div class="row" gutter="20">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-7 logo-holder">
                        ...
                        <!-- ============================================================= LOGO ============================================================= -->
                        <div class="logo"><a href="./"> 安心美食外卖平台 </a></div>
                        <!-- /.logo -->
                        <!-- ============================================================= LOGO : END ============================================================= -->
...
<li>
<a href="shangpinxinxilist.do">商品
</a>
<ul class="nav-child">
                    <ssm:sql var="mapshangpinfenlei1" type="select">SELECT id,fenleimingcheng FROM shangpinfenlei</ssm:sql>
<c:forEach items="${mapshangpinfenlei1}" var="m"><c:set var="m" value="${m}" scope="request" />
<li><a href="shangpinxinxilist.do?fenlei=${m.id}">${m.fenleimingcheng}</a></li>
</c:forEach>
</ul>
</li>
<li>
<a href="xinwenxinxilist.do">新闻
</a>
<ul class="nav-child">
                    <ssm:sql var="mapxinwenfenlei2" type="select">SELECT id,fenleimingcheng FROM xinwenfenlei</ssm:sql>
<c:forEach items="${mapxinwenfenlei2}" var="m"><c:set var="m" value="${m}" scope="request" />
<li><a href="xinwenxinxilist.do?fenlei=${m.id}">${m.fenleimingcheng}</a></li>
</c:forEach>
</ul>
</li>
<li>
<a href="liuyanbanadd.do">反馈
</a>
</li>
<li>
